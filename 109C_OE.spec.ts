...
# Name of the document library (e.g., "Folder Move Test 01")
$libraryName = "Folder Move Test 01"

# Prefix for target folders (e.g., "_Folder")
$targetFolderPrefix = "_Folder"
...
# Define the target folder name (e.g., "_Folder")
